...
FMS_PARAM_VALUE.TAKEOFF_H = single(1.0);
...
FMS_PARAM_VALUE.FW_L1 = single(30);
FMS_PARAM_VALUE.FW_CRUISE_SPEED = single(20);
FMS_PARAM_VALUE.FW_CRUISE_SPEED_MIN = single(17);
...
FMS_PARAM_VALUE.FW_PITCH_LIM = single(pi/4);
FMS_PARAM_VALUE.FW_YAW_RATE_LIM = single(pi/3);
FMS_PARAM_VALUE.FW_AIRSPD_MAX = single(22.0);
...
FMS_PARAM_VALUE.FW_ACCEPT_R = single(55.0);
