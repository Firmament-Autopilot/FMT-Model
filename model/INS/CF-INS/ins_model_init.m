...
INS_PARAM_VALUE.GPS_POS_DELAY = uint32(100);
INS_PARAM_VALUE.GPS_VEL_DELAY = uint32(100);
INS_PARAM_VALUE.GPS_X_OFFSET = single(0);
INS_PARAM_VALUE.GPS_Y_OFFSET = single(0);
INS_PARAM_VALUE.GPS_Z_OFFSET = single(0);
...
INS_PARAM_VALUE.EXTPOS_PSI_MODE = uint8(3);
INS_PARAM_VALUE.EXTPOS_PSI = single(0);
% INS_PARAM_VALUE.TERRAIN_TRACK = uint8(1);
