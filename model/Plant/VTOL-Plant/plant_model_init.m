...
% plant_model.main_motorCm = 1.982e-07;	% Rotor torque coefficient(kg.m^2)
plant_model.main_motorCt = 4.951e-05;	% Rotor thrust coefficient(kg.m^2)
% plant_model.main_motorR = 0.225; % Body radius(m)

plant_model.main_motorCr = 718.078; %Motor throttle-speed curve slope(rad/s)
plant_model.main_motorWb = 88.448;  %Motor speed-throttle curve constant term(rad/s)
plant_model.main_motorT = 0.02;  %Motor inertia time constant(s)
plant_model.main_motorJm = 0.0001287;    %Moment of inertia of motor rotor + propeller(kg.m^2)

%% Multicopter parameters
plant_model.Cm = 6.711e-07;	% Rotor torque coefficient(kg.m^2)
plant_model.Ct = 4.195e-05;	% Rotor thrust coefficient(kg.m^2)
