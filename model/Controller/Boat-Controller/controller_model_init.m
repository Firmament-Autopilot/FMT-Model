...
CONTROL_PARAM_VALUE.VEL_I_MAX = single(0.2);
CONTROL_PARAM_VALUE.VEL_I_MIN = single(-0.2);
CONTROL_PARAM_VALUE.VEL_D_MAX = single(0.1);
CONTROL_PARAM_VALUE.VEL_D_MIN = single(-0.1);
CONTROL_PARAM_VALUE.PSI_RATE_P = single(1.0);
CONTROL_PARAM_VALUE.THROTTLE_SCALE = single(1000);
CONTROL_PARAM_VALUE.THROTTLE_BIAS = uint16(1000);
