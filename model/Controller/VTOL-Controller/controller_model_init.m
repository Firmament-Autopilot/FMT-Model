...
CONTROL_PARAM_VALUE.MC_ROLL_RATE_P = single(0.18);
CONTROL_PARAM_VALUE.MC_PITCH_RATE_P = single(0.18);
...
CONTROL_PARAM_VALUE.MC_R_CMD_LIM = single(pi/3);
...
CONTROL_PARAM_VALUE.FW_TECS_THOR_P = single(0.75);
