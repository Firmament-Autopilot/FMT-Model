...
CONTROL_PARAM_VALUE.MC_ROLL_PITCH_CMD_LIM = single(pi/6);

CONTROL_PARAM_VALUE.MC_ROLL_RATE_P = single(0.15);
CONTROL_PARAM_VALUE.MC_PITCH_RATE_P = single(0.2);
CONTROL_PARAM_VALUE.MC_YAW_RATE_P = single(0.6);
CONTROL_PARAM_VALUE.MC_ROLL_RATE_I = single(0.15);
CONTROL_PARAM_VALUE.MC_PITCH_RATE_I = single(0.15);
CONTROL_PARAM_VALUE.MC_YAW_RATE_I = single(0.2);
CONTROL_PARAM_VALUE.MC_ROLL_RATE_D = single(0.006);
CONTROL_PARAM_VALUE.MC_PITCH_RATE_D = single(0.009);
CONTROL_PARAM_VALUE.MC_YAW_RATE_D = single(0.02);
CONTROL_PARAM_VALUE.MC_ROLL_RATE_FF = single(0.0);
CONTROL_PARAM_VALUE.MC_PITCH_RATE_FF = single(0.0);
CONTROL_PARAM_VALUE.MC_RATE_I_MIN = single(-0.3);
CONTROL_PARAM_VALUE.MC_RATE_I_MAX = single(0.3);
CONTROL_PARAM_VALUE.MC_RATE_D_MIN = single(-0.3);
CONTROL_PARAM_VALUE.MC_RATE_D_MAX = single(0.3);
CONTROL_PARAM_VALUE.MC_P_Q_CMD_LIM = single(pi/3);
CONTROL_PARAM_VALUE.MC_R_CMD_LIM = single(pi/4);
CONTROL_PARAM_VALUE.MC_HOVER_THRO = single(0.5);
CONTROL_PARAM_VALUE.MC_OUT_MAX = uint16(2000);
CONTROL_PARAM_VALUE.MC_OUT_MIN = uint16(1000);

% CONTROL_PARAM_VALUE.FW_ROLL_P = single(10);
% CONTROL_PARAM_VALUE.FW_PITCH_P = single(20);
CONTROL_PARAM_VALUE.FW_ROLL_P = single(5);
CONTROL_PARAM_VALUE.FW_PITCH_P = single(5);
CONTROL_PARAM_VALUE.FW_ROLL_PITCH_CMD_LIM = single(pi/4);

% CONTROL_PARAM_VALUE.FW_ROLL_RATE_P = single(0.1);
% CONTROL_PARAM_VALUE.FW_PITCH_RATE_P = single(1);
CONTROL_PARAM_VALUE.FW_ROLL_RATE_P = single(0.1);
CONTROL_PARAM_VALUE.FW_PITCH_RATE_P = single(0.15);
CONTROL_PARAM_VALUE.FW_YAW_RATE_P = single(0.15);
...
CONTROL_PARAM_VALUE.FW_RATE_I_MIN = single(-0.4);
CONTROL_PARAM_VALUE.FW_RATE_I_MAX = single(0.4);
CONTROL_PARAM_VALUE.FW_P_Q_CMD_LIM = single(pi/3);
CONTROL_PARAM_VALUE.FW_R_CMD_LIM = single(pi/6);
CONTROL_PARAM_VALUE.FW_YAW_RATE_LIM = single(pi/6);
...
CONTROL_PARAM_VALUE.FW_PITCH_OFFSET = single(0);
CONTROL_PARAM_VALUE.FW_CRUISE_THRO = single(0.5);

CONTROL_PARAM_VALUE.FW_TECS_PITCH_F = single(0.2);
CONTROL_PARAM_VALUE.FW_TECS_THOR_FF = single(0.25);
% CONTROL_PARAM_VALUE.FW_TECS_PITCH_P = single(0.1);
CONTROL_PARAM_VALUE.FW_TECS_PITCH_P = single(0.2);
% CONTROL_PARAM_VALUE.FW_TECS_THOR_P = single(0.1);
CONTROL_PARAM_VALUE.FW_TECS_THOR_P = single(1.0);
% CONTROL_PARAM_VALUE.FW_TECS_PITCH_I = single(0.1);
CONTROL_PARAM_VALUE.FW_TECS_PITCH_I = single(0.15);
% CONTROL_PARAM_VALUE.FW_TECS_PITCH_I_LIM = single(0.2);
CONTROL_PARAM_VALUE.FW_TECS_PITCH_I_LIM = single(0.3);
CONTROL_PARAM_VALUE.FW_TECS_THOR_I = single(0.2);
...
CONTROL_PARAM_VALUE.FW_TECS_W2P = single(1.5);
% CONTROL_PARAM_VALUE.FW_TECS_U2P = single(0.1);
CONTROL_PARAM_VALUE.FW_TECS_U2P = single(0.2); %%%%
% CONTROL_PARAM_VALUE.FW_TECS_R2P = single(0.1);
% CONTROL_PARAM_VALUE.FW_TECS_R2T = single(0.1);
CONTROL_PARAM_VALUE.FW_TECS_R2P = single(0.0);
CONTROL_PARAM_VALUE.FW_TECS_R2T = single(0.0);
CONTROL_PARAM_VALUE.FW_OUT_MAX = uint16(2000);
CONTROL_PARAM_VALUE.FW_OUT_MIN = uint16(1000);
