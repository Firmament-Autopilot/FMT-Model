...
CONTROL_PARAM_VALUE.MC_ROLL_RATE_P = single(0.3);
CONTROL_PARAM_VALUE.MC_PITCH_RATE_P = single(0.3);
CONTROL_PARAM_VALUE.MC_YAW_RATE_P = single(0.6);
CONTROL_PARAM_VALUE.MC_ROLL_RATE_I = single(0.3);
CONTROL_PARAM_VALUE.MC_PITCH_RATE_I = single(0.3);
CONTROL_PARAM_VALUE.MC_YAW_RATE_I = single(0.4);
CONTROL_PARAM_VALUE.MC_ROLL_RATE_D = single(0.009);
CONTROL_PARAM_VALUE.MC_PITCH_RATE_D = single(0.009);
CONTROL_PARAM_VALUE.MC_YAW_RATE_D = single(0.002);
CONTROL_PARAM_VALUE.MC_ROLL_RATE_FF = single(0.0);
CONTROL_PARAM_VALUE.MC_PITCH_RATE_FF = single(0.0);
CONTROL_PARAM_VALUE.MC_RATE_I_MIN = single(-0.25);
CONTROL_PARAM_VALUE.MC_RATE_I_MAX = single(0.25);
CONTROL_PARAM_VALUE.MC_RATE_D_MIN = single(-0.25);
CONTROL_PARAM_VALUE.MC_RATE_D_MAX = single(0.25);
...
CONTROL_PARAM_VALUE.FW_RATE_I_MIN = single(-0.3);
CONTROL_PARAM_VALUE.FW_RATE_I_MAX = single(0.3);
CONTROL_PARAM_VALUE.FW_P_Q_CMD_LIM = single(pi/2);
CONTROL_PARAM_VALUE.FW_R_CMD_LIM = single(pi);
CONTROL_PARAM_VALUE.FW_YAW_RATE_LIM = single(pi/4);
...
CONTROL_PARAM_VALUE.FW_TECS_THOR_P = single(0.5);
