...
CONTROL_PARAM_VALUE.LADRC_ROLL_B0=single(300);
CONTROL_PARAM_VALUE.LADRC_PITCH_B0=single(300);
CONTROL_PARAM_VALUE.LADRC_YAW_B0=single(200);
CONTROL_PARAM_VALUE.LADRC_ROLL_BETA1=single(500);
CONTROL_PARAM_VALUE.LADRC_PITCH_BETA1=single(500);
CONTROL_PARAM_VALUE.LADRC_YAW_BETA1=single(350);
CONTROL_PARAM_VALUE.LADRC_ROLL_BETA2=single(1800);
CONTROL_PARAM_VALUE.LADRC_PITCH_BETA2=single(1800);
CONTROL_PARAM_VALUE.LADRC_YAW_BETA2=single(1400);
CONTROL_PARAM_VALUE.LADRC_ROLL_GAMMA=single(0.5);
CONTROL_PARAM_VALUE.LADRC_PITCH_GAMMA=single(0.5);
CONTROL_PARAM_VALUE.LADRC_YAW_GAMMA=single(0.5);
CONTROL_PARAM_VALUE.LADRC_ROLL_Z2_LIM=single(60);
CONTROL_PARAM_VALUE.LADRC_PITCH_Z2_LIM=single(60);
CONTROL_PARAM_VALUE.LADRC_YAW_Z2_LIM=single(100);
