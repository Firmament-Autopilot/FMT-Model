...
CONTROL_PARAM_VALUE.ROLL_PITCH_CMD_LIM = single(pi/3);
...
CONTROL_PARAM_VALUE.FW_TECS_ANSW = single(1);
CONTROL_PARAM_VALUE.FW_TECS_VERR_K = single(1);
CONTROL_PARAM_VALUE.FW_TECS_ANG_K = single(1);
CONTROL_PARAM_VALUE.FW_TECS_W2T = single(1);
CONTROL_PARAM_VALUE.FW_TECS_U2T = single(1);
CONTROL_PARAM_VALUE.FW_TECS_R2P = single(0.2);
CONTROL_PARAM_VALUE.FW_TECS_R2T = single(0.2);
