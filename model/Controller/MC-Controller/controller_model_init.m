...
CONTROL_PARAM_VALUE.ROLL_RATE_P = single(0.045);
CONTROL_PARAM_VALUE.PITCH_RATE_P = single(0.045);
CONTROL_PARAM_VALUE.YAW_RATE_P = single(0.15);
CONTROL_PARAM_VALUE.ROLL_RATE_I = single(0.05);
CONTROL_PARAM_VALUE.PITCH_RATE_I = single(0.05);
CONTROL_PARAM_VALUE.YAW_RATE_I = single(0.15);
CONTROL_PARAM_VALUE.ROLL_RATE_D = single(0.0015);
CONTROL_PARAM_VALUE.PITCH_RATE_D = single(0.0015);
CONTROL_PARAM_VALUE.YAW_RATE_D = single(0.001);
CONTROL_PARAM_VALUE.ROLL_RATE_FF = single(0.01);
CONTROL_PARAM_VALUE.PITCH_RATE_FF = single(0.01);
CONTROL_PARAM_VALUE.YAW_RATE_FF = single(0.03);
