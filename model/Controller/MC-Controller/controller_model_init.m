...
CONTROL_PARAM_VALUE.VEL_XY_D = single(0.05);
CONTROL_PARAM_VALUE.VEL_Z_P = single(0.5);
CONTROL_PARAM_VALUE.VEL_Z_I = single(0.12);
...
CONTROL_PARAM_VALUE.VEL_Z_I_MIN = single(-0.2);
CONTROL_PARAM_VALUE.VEL_Z_I_MAX = single(0.2);
...
CONTROL_PARAM_VALUE.ROLL_RATE_P = single(0.15);
CONTROL_PARAM_VALUE.PITCH_RATE_P = single(0.15);
CONTROL_PARAM_VALUE.YAW_RATE_P = single(0.3);
CONTROL_PARAM_VALUE.ROLL_RATE_I = single(0.15);
CONTROL_PARAM_VALUE.PITCH_RATE_I = single(0.15);
CONTROL_PARAM_VALUE.YAW_RATE_I = single(0.3);
CONTROL_PARAM_VALUE.ROLL_RATE_D = single(0.005);
CONTROL_PARAM_VALUE.PITCH_RATE_D = single(0.005);
CONTROL_PARAM_VALUE.YAW_RATE_D = single(0.002);
CONTROL_PARAM_VALUE.ROLL_RATE_FF = single(0.03);
CONTROL_PARAM_VALUE.PITCH_RATE_FF = single(0.03);
CONTROL_PARAM_VALUE.YAW_RATE_FF = single(0.05);
CONTROL_PARAM_VALUE.RATE_I_MIN = single(-0.2);
CONTROL_PARAM_VALUE.RATE_I_MAX = single(0.2);
CONTROL_PARAM_VALUE.RATE_D_MIN = single(-0.2);
CONTROL_PARAM_VALUE.RATE_D_MAX = single(0.2);
