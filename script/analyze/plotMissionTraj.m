...
%sp_waypoint_x = [sp_waypoint(:, 1); x_R(1, 1)];%航点加上返航目标点
%sp_waypoint_y = [sp_waypoint(:, 2); y_R(1, 1)];%航点加上返航目标点
